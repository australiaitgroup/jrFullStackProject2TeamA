...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__Dashboard__models__activities.js' */'/Users/jracademy/Documents/FullStackProject/src/pages/Dashboard/models/activities.js').then(m => { return { namespace: 'activities',...m.default}}),
  import(/* webpackChunkName: 'p__Dashboard__models__chart.js' */'/Users/jracademy/Documents/FullStackProject/src/pages/Dashboard/models/chart.js').then(m => { return { namespace: 'chart',...m.default}}),
  import(/* webpackChunkName: 'p__Dashboard__models__monitor.js' */'/Users/jracademy/Documents/FullStackProject/src/pages/Dashboard/models/monitor.js').then(m => { return { namespace: 'monitor',...m.default}})
],
...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__Forms__models__form.js' */'/Users/jracademy/Documents/FullStackProject/src/pages/Forms/models/form.js').then(m => { return { namespace: 'form',...m.default}})
],
...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__List__models__rule.js' */'/Users/jracademy/Documents/FullStackProject/src/pages/List/models/rule.js').then(m => { return { namespace: 'rule',...m.default}})
],
...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__Profile__models__profile.js' */'/Users/jracademy/Documents/FullStackProject/src/pages/Profile/models/profile.js').then(m => { return { namespace: 'profile',...m.default}})
],
...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__Exception__models__error.js' */'/Users/jracademy/Documents/FullStackProject/src/pages/Exception/models/error.js').then(m => { return { namespace: 'error',...m.default}})
],
